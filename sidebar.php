    ...
    <aside class="px-2 pt-2 h-auto min-h-full w-[19rem] bg-base-200 text-base-content flex flex-col">
        ...
        if ( has_nav_menu( 'sidebar-menu' ) ) {
            ...
            <ul class="menu grow shrink menu-md overflow-y-auto">
                ...
                <li><a class="py-3 text-base<?php if ( ! is_front_page() && is_post_type_archive( 'service' ) ) echo ' bg-base-300'; ?>" href="<?php echo esc_url( get_post_type_archive_link( 'service' ) ); ?>">Services</a></li>
                ...
                <li><a class="py-3 text-base<?php if ( ! is_front_page() && ( is_home() || is_singular( 'post' ) || is_tag() || is_category() ) ) echo ' bg-base-300'; ?>" href="<?php
$posts_page_id = get_option( 'page_for_posts' );
echo esc_url( $posts_page_id ? get_permalink( $posts_page_id ) : home_url( '/blog/' ) );
?>">Blog</a></li>
                <li><a class="py-3 text-base<?php if ( ! is_front_page() && is_page( 'cv' ) ) echo ' bg-base-300'; ?>" href="<?php echo esc_url( home_url( '/cv/' ) ); ?>">CV</a></li>
                <?php
